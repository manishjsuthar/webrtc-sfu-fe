...
const TutorProctoring = () => {
  ...
  //     console.log("producerId, producerUserId ", producerId, producerUserId);
  ...
  //   let randomDigits = random > 9 ? random.toString() : "0" + random;
  //   console.log("randomDigits ", randomDigits);

  //   socket.emit(
  //     "joinRoom",
  //     { roomName, role: "teacher", name: "admin test", id: randomDigits },
  //     (data) => {
  ...
  //               console.log(
  //                 "sdd serverConsumerTransportId connect",
  //                 dtlsParameters,
  //                 params.id
  //               );
  ...
  //   }
  //   socket.emit(
  //     "resumeProducerStream",
  //     { userId, kind: isChecked === true ? "video" : "audio" },
  //     (response) => {
  //       if (response.success) {
